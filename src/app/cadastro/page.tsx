...
import { TicketPrinter, createTicketEntradaData } from "@/components/ticket-printer";
...
export default function Cadastro() {   
  ...
  async function cadastrarCarro(formData: FormData) {
    ...
    const andar = Number(formData.get("andar"));
    const lado = formData.get("lado") as string;
    const vaga = Number(formData.get("vaga"));
    ...
    if (response.error) {
      ...
      // Cria dados do ticket de entrada
      const ticket = createTicketEntradaData(
        placa as string,
        modelo as string,
        andar,
        lado as string,
